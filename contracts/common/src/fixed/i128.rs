...
use crate::{fixed::fixed_point::FixedPoint, fixed::soroban_fixed_point::SorobanFixedPoint};
...
fn scaled_mul_div_floor(x: &i128, env: &Env, y: &i128, z: &i128) -> i128 {
    return match x.checked_mul(*y) {
        ...
        None => {
            ...
            let res = crate::fixed::i256::mul_div_floor(
                &env,
...
fn scaled_mul_div_ceil(x: &i128, env: &Env, y: &i128, z: &i128) -> i128 {
    return match x.checked_mul(*y) {
        ...
        None => {
            // scale to i256 and retry
            let res = crate::fixed::i256::mul_div_ceil(
                &env,
                &I256::from_i128(&env, *x),
                &I256::from_i128(&env, *y),
                &I256::from_i128(&env, *z),
...
mod test_fixed_point {
    ...
    use crate::fixed::fixed_point::FixedPoint;
...
mod test_soroban_fixed_point {
    use crate::fixed::soroban_fixed_point::SorobanFixedPoint;
    use soroban_sdk::Env;
