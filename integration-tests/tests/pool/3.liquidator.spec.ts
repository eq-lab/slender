...
describe("LendingPool: Liquidation (receive STokens)", function () {
    ...
    it("Case 1: Liquidator, Lender & Borrower deposit assets", async function () {
        ...
        assert.equal(lender1XrpBalance, 90_000_000_000n);
        assert.equal(lender1SXrpBalance, 10_000_000_000n);
        assert.equal(lender1UsdcBalance, 90_000_000_000n);
        ...
        assert.equal(sUsdcBalance, 20_000_000_000n);

        assert.equal(sXlmSupply, 50_000_000_000n);
        assert.equal(sXrpSupply, 20_000_000_000n);
        assert.equal(sUsdcSupply, 20_000_000_000n);
    });
    ...
    it("Case 2: Borrower borrows XLM with npv ~= 0", async function () {
        ...
        assert.equal(sXlmBalance, 38_001_000_000n);
    ...
    it("Case 3: Liquidator borrows XRP more than Borrower deposited", async function () {
        ...
        assert.equal(sXrpBalance, 9_000_000_000n);
    ...
    it("Case 4: Liquidator borrows USDC less than Borrower deposited", async function () {
        ...
        assert.equal(sUsdcBalance, 11_000_000_000n);
    ...
    it("Case 4: Drop the XRP price so Borrower's NPV <= 0", async function () {
        // XRP price is set to 1_000_000_000 USDC
    ...
    it("Case 5: Liquidator liquidates Borrower's positions", async function () {
        ...
        const sXlmSupply = await sTokenTotalSupply(client, "XRP");
        const sUsdcSupply = await sTokenTotalSupply(client, "USDC");
